...
const services = [
  { id: '1', name: 'AC Installation', price: '$150', time: 'Approx. 2 hours', rating: 4.9, reviews: 100, image: 'https://via.placeholder.com/100' },
  { id: '2', name: 'AC Repair', price: '$80', time: 'Approx. 1 hour', rating: 4.7, reviews: 80, image: 'https://via.placeholder.com/100' },
  { id: '3', name: 'AC Maintenance', price: '$60', time: 'Approx. 1.5 hours', rating: 4.8, reviews: 120, image: 'https://via.placeholder.com/100' },
];
