...
const services = [
  { id: '1', name: 'Fan Installation', price: '$20', time: 'Approx. 30 minutes', rating: 4.8, reviews: 120, image: 'https://via.placeholder.com/100' },
  { id: '2', name: 'Wiring Installation', price: '$50', time: 'Approx. 1 hour', rating: 4.5, reviews: 80, image: 'https://via.placeholder.com/100' },
  { id: '3', name: 'Lighting Installation', price: '$30', time: 'Approx. 45 minutes', rating: 4.7, reviews: 100, image: 'https://via.placeholder.com/100' },
];
    ...
    <View style={styles.serviceCard}>
      ...
      <View style={styles.serviceDetails}>
        ...
        <View style={styles.actions}>
          ...
          <Pressable onPress={() => alert('View Details')} style={styles.viewDetails}>
...
const styles = StyleSheet.create({
  ...
  serviceList: {
    paddingBottom: 100, // To avoid overlap with the modal
  },
  serviceCard: {
    flexDirection: 'row',
    backgroundColor: '#FFFFFF',
