...
const services = [
  { id: '1', name: 'Oil Change', price: '$30', time: 'Approx. 1 hour', rating: 4.8, reviews: 100, image: 'https://via.placeholder.com/100' },
  { id: '2', name: 'Tire Rotation', price: '$20', time: 'Approx. 30 minutes', rating: 4.7, reviews: 80, image: 'https://via.placeholder.com/100' },
  { id: '3', name: 'Brake Inspection', price: '$40', time: 'Approx. 1 hour', rating: 4.9, reviews: 120, image: 'https://via.placeholder.com/100' },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Mechanic Services</Text>
