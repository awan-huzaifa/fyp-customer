...
const services = [
  { id: '1', name: 'Deep Cleaning', price: '$50', time: 'Approx. 2 hours', rating: 4.9, reviews: 150, image: 'https://via.placeholder.com/100' },
  { id: '2', name: 'Window Cleaning', price: '$30', time: 'Approx. 1 hour', rating: 4.7, reviews: 80, image: 'https://via.placeholder.com/100' },
  { id: '3', name: 'Carpet Cleaning', price: '$40', time: 'Approx. 1.5 hours', rating: 4.8, reviews: 120, image: 'https://via.placeholder.com/100' },
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        <TextInput
          ...
          placeholder="Search Home Cleaning Services..."
