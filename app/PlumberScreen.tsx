...
const services = [
  { id: '1', name: 'Pipe Installation', price: '$100', time: 'Approx. 2 hours', rating: 4.8, reviews: 90, image: 'https://via.placeholder.com/100' },
  { id: '2', name: 'Leak Repair', price: '$50', time: 'Approx. 1 hour', rating: 4.7, reviews: 70, image: 'https://via.placeholder.com/100' },
  { id: '3', name: 'Drain Cleaning', price: '$40', time: 'Approx. 1.5 hours', rating: 4.9, reviews: 50, image: 'https://via.placeholder.com/100' },
];

const PlumberScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Plumber Services</Text>
